...
| IX.46 | Educational Life Graph | `ch46-life-graph.md` | `public/aquin-lifegraph.js` | 7 |
...
| XV.64 | Educational Self-Model (computational self-model) | `ch64-selfmodel.md` | `public/aquin-selfmodel.js` | 8 |
