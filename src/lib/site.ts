export const SITE = {
  ...
  socials: {
    linkedin: 'https://www.linkedin.com/company/edurankai/'
  },
  copyright: '(c) 2026 EduRankAI - Building for Bharat. Building for the World.'
};

export const NAV_PRIMARY = [
  { label: 'HEI', href: '/hei' },
  { label: 'AquinTutor', href: '/aquintutor' },
