...
export const PRODUCTS = [
  ...
  {
    name: 'karate.support',
    tagline: 'Infrastructure for the global karate community',
    status: 'Launching 30 May 2026',
    statusVariant: 'launch',
    href: 'https://www.karate.support',
    external: true,
    description: 'A complete platform for the global karate community — instructor discovery, dojo management, training resources, certification tracking, and tournament infrastructure. Pre-launched now. iOS and Android apps shipping 30 May 2026.'
  },
  {
    name: 'Sambandh',
