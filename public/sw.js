...
const CACHE = 'edurankai-v17';
const STATIC_CACHE = 'edurankai-static-v17';
const PAGE_CACHE = 'edurankai-pages-v17';
...
const PRECACHE = ['/', '/resume', '/portal/worklog', '/careers', '/ecosystem',
  ...
  '/aquintutor/labs/cad-studio', '/aquintutor/labs/cad-assembly', '/aquintutor/labs/cad-fea', '/aquintutor/labs/nn-playground', '/aquintutor/labs/exploit-sandbox', '/aquintutor/labs/mcu-emulator'];
