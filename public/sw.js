...
const CACHE = 'edurankai-v14';
const STATIC_CACHE = 'edurankai-static-v14';
const PAGE_CACHE = 'edurankai-pages-v14';
...
const PRECACHE = ['/', '/resume', '/portal/worklog', '/careers', '/ecosystem',
  ...
  '/aquintutor/labs/cad-studio', '/aquintutor/labs/cad-assembly', '/aquintutor/labs/cad-fea'];
