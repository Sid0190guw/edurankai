...
const roles = [
  {
    ...
    location: "On-site — Kolkata, West Bengal, India",
    duration: "3-6 Months",
    salary: "Unpaid + Full ownership of the product you ship + Direct Founder Office mentorship + Priority pathway to full-time roles on exceptional contribution",
    about: "This is EduRankAI's most ambitious internship. You will be handed full ownership of a real product within the EduRankAI ecosystem - not a side project, not a feature, but an entire product. You build it. You launch it. You drive its first revenue. Exceptional performers are fast-tracked into Founder Office full-time roles. The reward is real, the work is real, and the product you ship is yours to point to forever.",
    responsibilities: [
  ...
  },
  {
    ...
    location: "On-site — Kolkata, West Bengal, India",
    duration: "Permanent",
    salary: "Full-time compensation discussed individually with shortlisted candidates + Discretionary net-profit sharing for extraordinary C-level contribution",
    about: "Own the overall vision, strategy, and execution of EduRankAI. The CEO sets the direction for everything the company does, builds the team, and is ultimately responsible for outcomes. This is a role of total ownership and total accountability. Compensation is monetary, and it is discussed openly and individually at the offer stage.",
    responsibilities: [
  ...
  },
  {
    ...
    location: "On-site — Kolkata, West Bengal, India",
    duration: "Permanent",
    salary: "Senior package + Top-quartile for Bharat-based AI startups + Market context and budget shared openly + Reviewed annually",
  ...
  },
  {
    ...
    location: "On-site — Kolkata, West Bengal, India",
    duration: "Permanent",
    salary: "Competitive + Above-market for Bharat-based candidates + Budget shared openly at offer stage + Performance reviews twice yearly",
  ...
  },
  {
    ...
    location: "On-site — Kolkata, West Bengal, India",
    duration: "Permanent",
    salary: "Senior package + Top-quartile for Bharat-based AI startups + Market context and budget shared openly",
